...
def Plugins(**kwargs):
    return PluginDescriptor(name="MyMetrixLite", description=_("openPLI configuration tool for MetrixHD"), where = PluginDescriptor.WHERE_PLUGINMENU, icon="plugin.png", fnc=main)
