...
SKIN_OPENPLI_SOURCE = "/usr/share/enigma2/MetrixHD/skin_00o_openpli.xml"
SKIN_OPENPLI_TARGET = "/usr/share/enigma2/MetrixHD/skin_00o_openpli.MySkin.xml"
SKIN_OPENPLI_TARGET_TMP = SKIN_OPENPLI_TARGET + ".tmp"
...
def initWeatherConfig():
    ...
    config.plugins.MetrixWeather.woeid = ConfigNumber(default=720187) #Location (visit metrixhd.info)
...
#    BoxType = getBoxType()
    ...
    config.plugins.MyMetrixLiteOther.channelSelectionShowPig = ConfigYesNo(default=False)
    config.plugins.MyMetrixLiteOther.epgGrafShowPig = ConfigYesNo(default=False)
#######################################################################
