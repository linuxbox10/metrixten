...
"""
    ...
    def checkEHDinstalled(self):
        ...
        EHDtested = len(tested) == 2 and "et7x00mini" in tested[0] and config.plugins.MyMetrixLiteOther.EHDenabled.value in tested[1]
...
#
            ...
            if config.plugins.MyMetrixLiteOther.SkinDesignInfobarPicon.value == "1":
                posx = 33 + int(config.plugins.MyMetrixLiteOther.SkinDesignInfobarXPiconPosX.value)
                posy = 574 + int(config.plugins.MyMetrixLiteOther.SkinDesignInfobarXPiconPosY.value)
                ...
                posx = 0 + int(config.plugins.MyMetrixLiteOther.SkinDesignInfobarZZZPiconPosX.value)
                posy = 560 + int(config.plugins.MyMetrixLiteOther.SkinDesignInfobarZZZPiconPosY.value)
            ...
            ulsize = int(config.plugins.MyMetrixLiteOther.layeraunderlinesize.value)
            ulposy = int(config.plugins.MyMetrixLiteOther.layeraunderlineposy.value)
